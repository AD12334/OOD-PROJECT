...
public class Admin extends User {
     ...
     * <p>
     * When creating an employee we need files to store payslips so we also create a
     * payslip.csv to store their payslips,
     * Hourly employees are also created with an hours.csv to store their hours
     * worked since 2020
     ...
     * <p>
     * Generates random hours between 0 and 40 for an hourly paid employee up to the
     * current month and year (dependent on current day)
     * 
